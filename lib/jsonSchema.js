...
const GraphQLGeometryType = new GraphQLObjectType({
  name: 'Geometry',
  description: 'Point Geometry Input',
  fields: () => ({
    type: {
      type: GraphQLString,
    },
...
function primitiveToGraphQLType(type) {
  switch (type) {
    ...
    case 'geometry': return GraphQLGeometryType;
    case 'object': return GraphQLObjectType;
    default: return null;
  }
}
